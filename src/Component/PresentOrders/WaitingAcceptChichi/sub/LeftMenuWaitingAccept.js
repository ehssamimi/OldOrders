...
class LeftMenuWaitingAccept extends Component {
    constructor(props) {
        super(props);
        this.state={
            ...
            TimeProcess:{'header':"زمان مراحل قبل",'sub':{'زمان انجام پرداخت':'20:05','زمان ثبت شده':'21:18','جمع آوری در انبار':"21:45",' تایید پیک':"22"}},
            DurationProcess:{'header':"مدت زمان هر بخش",'sub':{'زمان انجام پرداخت':'70','زمان ثبت شده':'5','جمع آوری در انبار':"30",' تایید پیک':"15"}},
            ChichiManPosition:{'header':"موقعیت مکانی لحظه ای پیک",'sub':{'ادرس':'ساری میدان امام '}},
        }
    }
...
export default LeftMenuWaitingAccept;