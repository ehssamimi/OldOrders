...
import SingleUserOrder from "../SingelUserOrder/SingleUserOrder";
import HistoryOrderUserInfo from "../HistoryOrderUserInfo/HistoryOrderUserInfo";
import VoteChichiInUserHistory from "../../Vote/VoteChichiInUserHistory";
import UserFavorite from "../../UserFavorite/UserFavorite";
import Chichilistening from "../../Chichilistening/Chichilistening";

class CollapseRowOrdersHistory extends Component {
    constructor(props) {
        super(props);
        ...
        this.state = { collapse: false,store:'',sub:[],Keys:'',
            ...
            subRow:{
                ...
                ChichiInfo:{'header':"اطلاعات پیک",'sub':{'نام و نام خانوادگی ':'احسان صمیمی راد','شماره موبایل':"09112561701",' نوع وسیله نقلیه':'ماشین',' شماره پلاک':'162-62-325'}},
                Vote:{'header':"نظرسنجی",'sub':{'نظر کلی':'sad','نقاط ضعف':'نداریم','نقاط قوت':"برخورد مناسب پیک ، تسریع دریافت ، بسته بندی مناسببرخورد مناسب پیک ، تسریع دریافت ، بسته بندی مناسب "}},
                            ...
                            <div className='d-flex  w-100 ' style={{'flex-wrap': 'wrap'}}>
                                <div dir='rtl' className='w-100'>
                                    ...
                                    <div className=' justify-content-start flex-column '>
                                        ...
                                        <SingleUserOrder/>
                                        <HistoryOrderUserInfo/>



                                        <CollapseRow store={subRow.ChichiInfo}/>

                                        <VoteChichiInUserHistory/>
                                        <UserFavorite/>
                                        <Chichilistening/>
                                        {/*<CollapseRow store={subRow.Vote}/>*/}
...
export default CollapseRowOrdersHistory;