...
import ShowShowline from "./ShowShowLine/ShowShowline";
        ...
        return (
            <div dir='rtl' className='mt-2'>
                <Card>
                    ...
                    <ShowShowline label={'متن پیام'} value='لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با
                                ...
                                طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. در این صورت می توان امید داشت' col='col-12'/>

                        {/*<div className='d-flex col-5 mt-2'>*/}

                            {/*<span className='collapseValue gray spanWithOutBreak'>{'متن پیام'} <span*/}
                                {/*className='pl-2'>:</span></span>*/}
                            {/*<p className="DRTl  d-flex ">*/}
                            {/*</p>*/}
                        {/*</div>*/}
            </Card>
            </div>
